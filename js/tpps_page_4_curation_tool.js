(function ($) {
  Drupal.behaviors.tpps_page_4_curation_tool = {
    attach: function (context, settings) {
      // @TODO Minor. Convert icons to unicode symbols.
      // @TODO Minor. Block buttons while AJAX request is processing.
      // Attach event handlers only once.
      $('form[id^=tppsc-main]', context)
      .once('tpps_page_4_curation_tool', function() {
        let $form = $(this);
        // @TODO Replace 'context' with '$form' to make processing faster.
        // ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
