...
// @TODO Check if disabled fields are in use by submit_all.php script.
  ...
  SnpAssay::build($i, $form, $form_state);
  AssayDesign::build($i, $form, $form_state);
  SnpAssociation::build($i, $form, $form_state);
  SnpsPopulationStructure::build($i, $form, $form_state);
  SnpsKinship::build($i, $form, $form_state);
