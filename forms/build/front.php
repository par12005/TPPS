...
function tpps_front_create_form(array &$form, array $form_state) {
  ...
  $prefix_text .= "<a href=\"https://tpps.readthedocs.io/en/latest/\" target=\"blank\" class=\"landing-button\"><button type=\"button\" class=\"btn btn-default\">TPPS Documentation</button></a>";
  $prefix_text .= "<a href=\"$base_url/tpps/details\" target=\"blank\" class=\"landing-button\"><button type=\"button\" class=\"btn btn-default\">TPPS Studies</button></a>";
  if (module_exists('cartogratree')) {
    $prefix_text .= "<a href=\"$base_url/ct\" target=\"blank\" class=\"landing-button\"><button type=\"button\" class=\"btn btn-default\">CartograPlant</button></a>";
  }
  $prefix_text .= "</div></div>";
